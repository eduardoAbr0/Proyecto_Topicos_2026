                    ...
                    <div className="col-md-6 col-lg-4">
                        <div className="card shadow">
                            <div className="card-body p-4">
                                <h2 className="text-center mb-4" style={{ color: 'black' }}>Iniciar Sesión</h2>
                                <form onSubmit={handleLogin}>
                                    <div className="mb-3">
                                        <label htmlFor="username" className="form-label">Usuario</label>
                                        <input
                                            type="text" className="form-control" id="username" required
                                ...
                                <div className="text-center" >
                                    <p style={{ color: 'black' }}>¿No tienes cuenta? <Link href="/registro">Regístrate aquí</Link></p>
                                </div>
                            </div>
                        </div>
                    </div>
